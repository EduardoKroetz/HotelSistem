...
public class CreateReservations
{
  public static async Task Create()
  {
    var reservations = new List<Reservation>()
    {
      ...
      new(BaseRepositoryTest.Rooms[1], DateTime.Now, BaseRepositoryTest.Customers[1], 1,DateTime.Now.AddDays(8)),
      new(BaseRepositoryTest.Rooms[2], DateTime.Now, BaseRepositoryTest.Customers[2], 1,DateTime.Now.AddDays(5)),
      new(BaseRepositoryTest.Rooms[3], DateTime.Now, BaseRepositoryTest.Customers[3], 1,DateTime.Now.AddDays(8)),
      new(BaseRepositoryTest.Rooms[4], DateTime.Now, BaseRepositoryTest.Customers[4], 1,DateTime.Now.AddDays(5)),
      ...
      new(BaseRepositoryTest.Rooms[7], DateTime.Now, BaseRepositoryTest.Customers[3], 1,DateTime.Now.AddDays(3)),
      new(BaseRepositoryTest.Rooms[8], DateTime.Now, BaseRepositoryTest.Customers[2], 1,DateTime.Now.AddDays(9)),
      new(BaseRepositoryTest.Rooms[9], DateTime.Now, BaseRepositoryTest.Customers[1], 1,DateTime.Now.AddDays(1)),
    };
