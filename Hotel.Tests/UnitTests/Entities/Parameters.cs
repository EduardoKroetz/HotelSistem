...
public static class TestParameters
{
    ...
    public static readonly Room Room = new("Quarto padrão",22, 50m, 3, "Um quarto para hospedagem.", Category);
    ...
    public static readonly Service Service = new("Serviço de quarto","Servico de quarto", 30m, EPriority.Medium, 30);
