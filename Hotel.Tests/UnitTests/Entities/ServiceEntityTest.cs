...
public class ServiceEntityTest
{
    ...
    {
        var service = new Service("Preparar e servir o almoço", "Preparar e servir o almoço", 25m, EPriority.Medium, 55);
    ...
    {
        new Service(name, "descrição", price, EPriority.Medium, timeInMinutes);
        Assert.Fail();
    }
