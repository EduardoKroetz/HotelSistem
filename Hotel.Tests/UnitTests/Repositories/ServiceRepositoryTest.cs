...
public class ServiceRepositoryTest
{
    ...
    {
        var roomInvoiceWithServices = await BaseRepositoryTest.MockConnection.Context.Invoices.FirstOrDefaultAsync(x => x.Services.Count > 0);
        ...
        foreach (var service in services)
        {
            var hasInvoice = await BaseRepositoryTest.MockConnection.Context.Services
              .Where(x => x.Id == service.Id)
