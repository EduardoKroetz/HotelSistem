...
public partial class InvoiceHandler : IHandler
{
    private readonly IInvoiceRepository _repository;
    private readonly IReservationRepository _reservationRepository;
    private readonly IEmailService _emailService;
    public InvoiceHandler(IInvoiceRepository repository, IReservationRepository reservationRepository, IEmailService emailService)
    {
    ...
    public async Task<Response> HandleCreateAsync(Invoice invoice, Reservation reservation)
    {
        try
        {
